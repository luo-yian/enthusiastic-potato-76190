...
module.exports.handler = async function (event, context) {
  ...
  if (event.httpMethod === "OPTIONS") {
    return { statusCode: 204, headers: JSON.stringify(HEADERS) };
    ...
    const randomInsult = _.sample(schimpfworte);

    try {
      return {
        statusCode: 200, // http status code
        //https://answers.netlify.com/t/error-decoding-lambda-response-json-deploying-a-function/2425
        headers: {
        ...
        body: JSON.stringify({
          randomGreeting: randomInsult,
          returnIncomingData: fields,
        }),
      };
    } catch (err) {
